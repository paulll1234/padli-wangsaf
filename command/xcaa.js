...
case 'xnxxsearch':
                    ...
                    query = args.join(" ")
                    koncol = await getBuffer(`https://zenzapis.xyz/searching/xnxx?apikey=8dd8336cbd&query=${query}`)
...
igk = args.join(" ")
deshd = await getBuffer(`https://zenzapis.xyz/stalker/ig?username=${text}&apikey=8dd8336cbd`)
deshxs = deshd.result
...
ttk = args.join(" ")
csksyb = await getBuffer('https://zenzapis.xyz/stalker/tiktok?username=${text}&apikey=8dd8336cbd')
...
case 'nekopoi':{
              ...
              geof = await getBuffer(`https://zenzapis.xyz/animeweb/nhentai?query=114512&apikey=8dd8336cbd`)
              skdl = geof.result
...
case 'cersex':
m.reply(mess.wait)
kohg = await getBuffer('https://zenzapis.xyz/randomtext/cersex?apikey=8dd8336cbd')
let buttons = [
...
kohg = await getBuffer(`https://zenzapis.xyz/randomtext/bucinquote?apikey=8dd8336cbd`)
let buttons = [
{buttonId: `${command}`, buttonText: {displayText: 'Next'}, type: 1}
]
let buttonMessage = {
...
hasiltod = await getBuffer(`https://zenzapis.xyz/randomasupan/asupantiktok?apikey=8dd8336cbd`)
...
m.reply(mess.wait)
hasiltod = await getBuffer(`https://zenzapis.xyz/randomasupan/asupan?apikey=8dd8336cbd`)
